...
def test_sanitize_path():
    from boilerplate.os_utils import sanitize_path
...
def test_maybe_add_slash(folder):
    from boilerplate.os_utils import maybe_add_slash
...
def test_get_stdout_from_command():
    from boilerplate.os_utils import get_stdout_from_command
    command = ['echo', 'asdf']
...
def test_get_stdout_stderr_from_command():
    from boilerplate.os_utils import get_stdout_stderr_from_command
